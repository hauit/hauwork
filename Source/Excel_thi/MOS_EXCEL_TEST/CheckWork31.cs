...
// Type: MOS_EXCEL_TEST.CheckWork31
...
{
  public static class CheckWork31
  {
    public static string Check(int cauLon, Application a, Workbook d)
    {
      ...
      {
        case 0:
          return CheckWork31.Cau0(a, d);
        case 1:
          return CheckWork31.Cau1(a, d);
        case 2:
          return CheckWork31.Cau2(a, d);
        case 3:
          return CheckWork31.Cau3(a, d);
        case 4:
          return CheckWork31.Cau4(a, d);
        case 5:
          return CheckWork31.Cau5(a, d);
        case 6:
          return CheckWork31.Cau6(a, d);
        case 7:
          return CheckWork31.Cau7(a, d);
        case 8:
          return CheckWork31.Cau8(a, d);
        case 9:
          return CheckWork31.Cau9(a, d);
        default:
          return "Default 1";
      }
    }
    ...
    private static string Cau0(Application a, Workbook d)
    {
      try
      {
        Worksheet worksheet = (Worksheet) d.Worksheets[(object) "Drinks"];
        if (worksheet.get_Range((object) "A7", (object) "A7").Text.ToString() != "Donor")
          return "False(A7)";
        if (worksheet.get_Range((object) "G32", (object) "G32").Text.ToString() != "46323")
          return "False(G32)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau1(Application a, Workbook d)
    {
      try
      {
        if (((TableStyle) ((_Worksheet) d.Worksheets[(object) "Tea"]).ListObjects[(object) 1].TableStyle).Name != "TableStyleMedium9")
          return "False(TableStyleMedium9)";
      }
      catch (Exception ex)
      {
        return "False(something wrong)";
    ...
    private static string Cau2(Application a, Workbook d)
    {
      try
      {
        Worksheet worksheet = (Worksheet) d.Worksheets[(object) "Tea"];
        if (worksheet.Shapes.Count != 1)
          return "False(so luong chart)";
        if (((Axis) worksheet.Shapes.Item((object) 1).Chart.Axes((object) XlAxisType.xlValue)).AxisTitle.Text != "Price")
          return "False(Price)";
        if (((Axis) worksheet.Shapes.Item((object) 1).Chart.Axes((object) XlAxisType.xlCategory)).HasTitle)
          return "False(xoa tieu de truc ngan)";
      }
      catch (Exception ex)
      {
        return "False(something wrong)";
    ...
    private static string Cau3(Application a, Workbook d)
    {
      try
      {
        if (((_Worksheet) d.Worksheets[(object) "Q1 Tea Sales"]).Shapes.Count != 0)
          return "False(so luong chart)";
        try
        {
          d.Sheets[(object) "Tea Sales"].ToString();
        }
        catch (Exception ex)
        {
          return "False(Tea Sales)";
        }
      }
      catch (Exception ex)
      {
    ...
    private static string Cau4(Application a, Workbook d)
    {
      try
      {
        if (((SeriesCollection) ((_Worksheet) d.Worksheets[(object) "Tea"]).Shapes.Item((object) 1).Chart.SeriesCollection(Type.Missing)).Item((object) 1).FormulaR1C1 != "=SERIES(Tea!R8C1,,Tea!R8C2,1)")
