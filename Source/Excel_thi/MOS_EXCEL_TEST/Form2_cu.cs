...
namespace MOS_EXCEL_TEST
{
    public class Form2_cu : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.textBoxPass.Location = new Point(140, 431);
            this.textBoxPass.Name = "textBoxPass";
            this.textBoxPass.PasswordChar = '*';
            this.textBoxPass.Size = new Size(398, 38);
            this.textBoxPass.TabIndex = 2;
            this.textBoxPass.Text = "123456";
            this.buttonOK.Location = new Point(320, 500);
            ...
            this.label1.Location = new Point(35, 384);
            ...
            this.label2.Location = new Point(35, 439);
        ...
        (object) "Test"
            ...
            this.comboBox1.Location = new Point(140, 478);
            ...
            this.label3.Location = new Point(35, 494);
            ...
            this.label4.Location = new Point(118, 100);
            this.label4.Name = "label4";
            this.label4.Size = new Size(416, 31);
            this.label4.TabIndex = 8;
            this.label4.Text = "PHẦN LÀM TEST EXCEL 2019";
            this.label5.AutoSize = true;
            this.label5.Font = new Font("Microsoft Sans Serif", 15.75f, FontStyle.Regular, GraphicsUnit.Point, (byte)0);
            this.label5.Location = new Point(135, 346);
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            {
                int num = (int)MessageBox.Show("Không thể copy file, bạn click chuột phải chọn run as administrator |" + ex.Message);
                this.Close();
            }
        }
        ...
        private void check(string KeyPath)
        {
            ...
            if (System.IO.File.Exists(KeyPath))
            {
                ...
                try
                {
                    ...
                    //textReader.Close();
                    string mac = "503EAA2D7A6A";
                    string str2 = "E2019";
                    string str3 = "V1.0";
                    string[] strArray = new string[] { "alo","6","2025","26"};
                    DateTime dateTime = new DateTime(int.Parse(strArray[2]), int.Parse(strArray[1]), int.Parse(strArray[3]));
                    ...
                    if (str2 != "E2019")
                    {
                        int num = (int)MessageBox.Show("Phần mềm E2019 mà key la " + str2);
                        System.IO.File.Delete(KeyPath);
                        this.Close();
                    }
                    try
