...
// Type: MOS_EXCEL_TEST.CheckWork32
...
{
  public static class CheckWork32
  {
    public static string Check(int cauLon, Application a, Workbook d)
    {
      ...
      {
        case 0:
          return CheckWork32.Cau0(a, d);
        case 1:
          return CheckWork32.Cau1(a, d);
        case 2:
          return CheckWork32.Cau2(a, d);
        case 3:
          return CheckWork32.Cau3(a, d);
        case 4:
          return CheckWork32.Cau4(a, d);
        case 5:
          return CheckWork32.Cau5(a, d);
        case 6:
          return CheckWork32.Cau6(a, d);
        case 7:
          return CheckWork32.Cau7(a, d);
        case 8:
          return CheckWork32.Cau8(a, d);
        case 9:
          return CheckWork32.Cau9(a, d);
        default:
          return "Default 1";
      }
    }
    ...
    private static string Cau1(Application a, Workbook d)
    {
      try
      {
        Worksheet worksheet = (Worksheet) d.Worksheets[(object) "Non-Fiction"];
        if (worksheet.get_Range((object) "H5", (object) "H5").Formula.ToString() != "=F5-G5")
          return "False(=F5-G5)";
        if (worksheet.get_Range((object) "H35", (object) "H35").Formula.ToString() != "=F35-G35")
          return "False(=F35-G35)";
        if (worksheet.get_Range((object) "H6", (object) "H6").Interior.Color.ToString() != "16777215")
    ...
    private static string Cau2(Application a, Workbook d)
    {
      try
      {
        string str = ((_Worksheet) d.Worksheets[(object) "Non-Fiction"]).get_Range((object) "F37", (object) "F37").Formula.ToString();
    ...
    private static string Cau3(Application a, Workbook d)
    {
      try
      {
        if (((_Worksheet) d.Worksheets[(object) "Non-Fiction"]).Index != 2)
          return "False(ch Non-Fiction nam giua)";
      }
      catch (Exception ex)
      {
        return "False (Something not finish!)";
    ...
    private static string Cau4(Application a, Workbook d)
    {
      ...
      try
      {
        worksheet = (Worksheet) d.Worksheets[(object) "Fiction"];
      }
      catch (Exception ex)
      {
      ...
      try
      {
        ...
        if (worksheet.Shapes.Item((object) "picture 2").Rotation.ToString() != "0")
