...
// Type: MOS_EXCEL_TEST.CheckWork35
...
{
  public static class CheckWork35
  {
    public static string Check(int cauLon, Application a, Workbook d)
    {
      ...
      {
        case 0:
          return CheckWork35.Cau0(a, d);
        case 1:
          return CheckWork35.Cau1(a, d);
        case 2:
          return CheckWork35.Cau2(a, d);
        case 3:
          return CheckWork35.Cau3(a, d);
        case 4:
          return CheckWork35.Cau4(a, d);
        case 5:
          return CheckWork35.Cau5(a, d);
        case 6:
          return CheckWork35.Cau6(a, d);
        case 7:
          return CheckWork35.Cau7(a, d);
        case 8:
          return CheckWork35.Cau8(a, d);
        case 9:
          return CheckWork35.Cau9(a, d);
        default:
          return "Default 1";
      }
    }
    ...
    private static string Cau0(Application a, Workbook d)
    {
      try
      {
        if (((_Worksheet) d.Worksheets[(object) "Personnel"]).get_Range((object) "D1", (object) "D1").EntireColumn.Hidden.ToString() == "False")
          return "False(ẩn Cột D)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau1(Application a, Workbook d)
    {
      try
      {
        if (((_Worksheet) d.Worksheets[(object) "Personnel"]).get_Range((object) "L8", (object) "L8").Formula.ToString() != "=LOWER([@[First Name]])")
          return "False(Lower)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau2(Application a, Workbook d)
    {
      try
      {
        Worksheet worksheet = (Worksheet) d.Worksheets[(object) "Personnel"];
        if (worksheet.get_Range((object) "A70", (object) "A70").Text.ToString() != "")
          return "False(goto và xoa noi dung)";
        if (worksheet.get_Range((object) "N73", (object) "N73").Text.ToString() != "")
          return "False(goto và xoa noi dung)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau3(Application a, Workbook d)
    {
      try
      {
        if (((_Worksheet) d.Worksheets[(object) "Personnel"]).PageSetup.PrintTitleRows != "$7:$7")
          return "False(dong 7)";
      }
      catch (Exception ex)
      {
