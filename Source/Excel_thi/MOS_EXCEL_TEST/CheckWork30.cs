...
// Type: MOS_EXCEL_TEST.CheckWork30
...
{
  public static class CheckWork30
  {
    public static string Check(int cauLon, Application a, Workbook d)
    {
      ...
      {
        case 0:
          return CheckWork30.Cau0(a, d);
        case 1:
          return CheckWork30.Cau1(a, d);
        case 2:
          return CheckWork30.Cau2(a, d);
        case 3:
          return CheckWork30.Cau3(a, d);
        case 4:
          return CheckWork30.Cau4(a, d);
        case 5:
          return CheckWork30.Cau5(a, d);
        case 6:
          return CheckWork30.Cau6(a, d);
        case 7:
          return CheckWork30.Cau7(a, d);
        default:
          return "Default 1";
      }
    }
    ...
    private static string Cau0(Application a, Workbook d)
    {
      try
      {
        ...
        if (worksheet.get_Range((object) "D1", (object) "D1").Text.ToString() != "Cell Phone")
          return "False (Cell Phone)";
        if (worksheet.get_Range((object) "C1", (object) "C1").Text.ToString() != "Home Phone")
          return "False (Home Phone)";
        if (worksheet.get_Range((object) "E1", (object) "E1").Text.ToString() != "Email")
          return "False (Email)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau2(Application a, Workbook d)
    {
      try
      {
        ...
        if (worksheet.get_Range((object) "A2", (object) "A2").Text.ToString() != "Katherine Berger")
          return "False (A2)";
        if (worksheet.get_Range((object) "C6", (object) "C6").Text.ToString() != "Gold")
          return "False (C6)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau3(Application a, Workbook d)
    {
      ...
      try
      {
        ...
        if (seriesCollection.Item((object) 1).FormulaR1C1 != "=SERIES(Demographics!R3C3,Demographics!R4C2:R7C2,Demographics!R4C3:R7C3,1)")
          return "False(series)";
