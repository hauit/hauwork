...
// Type: MOS_EXCEL_TEST.CheckWork33
...
{
  public static class CheckWork33
  {
    public static string Check(int cauLon, Application a, Workbook d)
    {
      ...
      {
        case 0:
          return CheckWork33.Cau0(a, d);
        case 1:
          return CheckWork33.Cau1(a, d);
        case 2:
          return CheckWork33.Cau2(a, d);
        case 3:
          return CheckWork33.Cau3(a, d);
        case 4:
          return CheckWork33.Cau4(a, d);
        case 5:
          return CheckWork33.Cau5(a, d);
        case 6:
          return CheckWork33.Cau6(a, d);
        case 7:
          return CheckWork33.Cau7(a, d);
        case 8:
          return CheckWork33.Cau8(a, d);
        case 9:
          return CheckWork33.Cau9(a, d);
        default:
          return "Default 1";
      }
    }
    ...
    private static string Cau0(Application a, Workbook d)
    {
      try
      {
        Worksheet worksheet = (Worksheet) d.Worksheets[(object) "Social Media Ads"];
        if (worksheet.get_Range((object) "A17", (object) "A17").Text.ToString() != "TULIP")
          return "False (comma)";
        if (worksheet.get_Range((object) "E18", (object) "E18").Text.ToString() != "2762")
          return "False (comma)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau1(Application a, Workbook d)
    {
      ...
      try
      {
        worksheet = (Worksheet) d.Worksheets[(object) "Inbound Calls"];
      }
      catch (Exception ex)
      {
    ...
    private static string Cau2(Application a, Workbook d)
    {
      ...
      try
      {
        if (worksheet.Shapes.Count != 2)
          return "False(khong them xoa chart)";
        float width = worksheet.Shapes.Item((object) 1).Width;
        float height = worksheet.Shapes.Item((object) 1).Height;
        if ((double) width > 335.0)
          return "False(w)";
        if ((double) height > 100.0)
          return "False(h)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau3(Application a, Workbook d)
    {
      ...
      try
      {
        ...
        worksheet = (Worksheet) d.Worksheets[(object) "Outbound Calls"];
      }
      catch (Exception ex)
      {
      ...
      try
      {
        ...
        if (worksheet.Shapes.Item((object) 1).Chart.ChartType != XlChartType.xl3DColumnClustered)
    ...
    private static string Cau4(Application a, Workbook d)
    {
      ...
      try
      {
        chart = worksheet.Shapes.Item((object) "Chart 1").Chart;
      }
      catch (Exception ex)
      {
        return "False (Not Chart)";
      ...
      try
      {
        if (((SeriesCollection) chart.SeriesCollection(Type.Missing)).Item((object) 1).FormulaR1C1 != "=SERIES('Inbound Calls'!R15C2,'Inbound Calls'!R2C3:R2C6,'Inbound Calls'!R15C3:R15C6,1)")
