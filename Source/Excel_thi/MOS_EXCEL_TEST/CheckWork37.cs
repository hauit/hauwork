...
// Type: MOS_EXCEL_TEST.CheckWork37
...
{
  public static class CheckWork37
  {
    public static string Check(int cauLon, Application a, Workbook d)
    {
      ...
      {
        case 0:
          return CheckWork37.Cau0(a, d);
        case 1:
          return CheckWork37.Cau1(a, d);
        case 2:
          return CheckWork37.Cau2(a, d);
        case 3:
          return CheckWork37.Cau3(a, d);
        case 4:
          return CheckWork37.Cau4(a, d);
        case 5:
          return CheckWork37.Cau5(a, d);
        case 6:
          return CheckWork37.Cau6(a, d);
        case 7:
          return CheckWork37.Cau7(a, d);
        case 8:
          return CheckWork37.Cau8(a, d);
        case 9:
          return CheckWork37.Cau9(a, d);
        default:
          return "Default 1";
      }
    }
    ...
    private static string Cau0(Application a, Workbook d)
    {
      ...
      try
      {
        worksheet = (Worksheet) d.Worksheets[(object) 3];
      }
      catch (Exception ex)
      {
        return "Fales (add new worksheet)";
      }
      try
      {
        if (worksheet.Name != "Q3 Sales")
    ...
    private static string Cau1(Application a, Workbook d)
    {
      ...
      try
      {
        worksheet = (Worksheet) d.Worksheets[(object) "Q1 Sales"];
      }
      catch (Exception ex)
      {
        return "Fales (Q1 Sales)";
      }
      try
      {
        if (!worksheet.get_Range((object) "G6", (object) "G6").Formula.ToString().Contains("=IF([@[Average Sales]]>=800,"))
          return "False(=IF([@[Average Sales]]>=800,\"Best Seller\",\"Below Expectations\"))";
      }
      catch (Exception ex)
      {
        return "Something wrong";
    ...
    private static string Cau2(Application a, Workbook d)
    {
      ...
      try
      {
        if (worksheet.get_Range((object) "H6", (object) "H36").SparklineGroups.Count.ToString() != "1")
          return "False(chen Sparkline tren 1 group)";
        if (worksheet.get_Range((object) "H6", (object) "H36").SparklineGroups[(object) 1].SourceData != "C6:E21")
          return "False(C6:E36)";
    ...
    private static string Cau3(Application a, Workbook d)
    {
      ...
      try
      {
        ...
        if (seriesCollection.Item((object) 3).FormulaR1C1 != "=SERIES('Q2 Sales'!R5C5,'Q2 Sales'!R6C1:R21C1,'Q2 Sales'!R6C5:R21C5,3)")
