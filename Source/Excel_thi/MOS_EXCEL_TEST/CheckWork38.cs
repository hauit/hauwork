...
// Type: MOS_EXCEL_TEST.CheckWork38
...
{
  public static class CheckWork38
  {
    public static string Check(int cauLon, Application a, Workbook d)
    {
      ...
      {
        case 0:
          return CheckWork38.Cau0(a, d);
        case 1:
          return CheckWork38.Cau1(a, d);
        case 2:
          return CheckWork38.Cau2(a, d);
        case 3:
          return CheckWork38.Cau3(a, d);
        case 4:
          return CheckWork38.Cau4(a, d);
        case 5:
          return CheckWork38.Cau5(a, d);
        case 6:
          return CheckWork38.Cau6(a, d);
        case 7:
          return CheckWork38.Cau7(a, d);
        case 8:
          return CheckWork38.Cau8(a, d);
        case 9:
          return CheckWork38.Cau9(a, d);
        default:
          return "Default 1";
      }
    }
    ...
    private static string Cau0(Application a, Workbook d)
    {
      try
      {
        if (d.Worksheets.Count != 4)
          return "False(them trang tinh)";
        Worksheet worksheet = (Worksheet) d.Worksheets[(object) "Microsoft Word"];
      }
      catch (Exception ex)
      {
    ...
    private static string Cau1(Application a, Workbook d)
    {
      try
      {
        Worksheet worksheet = (Worksheet) d.Worksheets[(object) "Key Applications"];
        if (worksheet.get_Range((object) "I2", (object) "I2").Formula.ToString() != "=IF(H2>719,\"Yes\",\"No\")")
          return "False(=IF(H2>719,\"Yes\",\"No\"))";
        if (worksheet.get_Range((object) "I30", (object) "I30").Formula.ToString() != "=IF(H30>719,\"Yes\",\"No\")")
    ...
    private static string Cau2(Application a, Workbook d)
    {
      ...
      try
      {
        worksheet = (Worksheet) d.Worksheets[(object) "Key Applications"];
      }
      catch (Exception ex)
      {
    ...
    private static string Cau3(Application a, Workbook d)
    {
      ...
      try
      {
        ...
        if (seriesCollection.Item((object) 3).FormulaR1C1 != "=SERIES(\"Average Score\",,'Key Applications'!R32C2:R32C7,3)")
    ...
    private static string Cau4(Application a, Workbook d)
    {
      ...
      try
      {
        worksheet = (Worksheet) d.Worksheets[(object) "Living Online"];
      }
      catch (Exception ex)
      {
        return "Fales (ten trang tinh)";
      ...
      try
      {
        if (worksheet.get_Range((object) "E32", (object) "E32").Text.ToString() != "=AVERAGE(E2:E30)")
