...
// Type: MOS_EXCEL_TEST.CheckWork17
...
namespace MOS_EXCEL_TEST
{
  public static class CheckWork17
  {
    ...
    private static string Cau0(Application a, Workbook d)
    {
      try
      {
        if (!((_Worksheet) d.Worksheets[(object) "Sales by Salesperson"]).ListObjects[(object) "Table1"].ShowTotals)
          return "Fales(ShowTotal trong table)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau1(Application a, Workbook d)
    {
      ...
      try
      {
        worksheet = (Worksheet) d.Worksheets[(object) "Sales by Product"];
      }
      catch (Exception ex)
      {
        return "Fales (Sales by Product)";
      }
      try
      {
        if (worksheet.Shapes.Item((object) "Chart 4").Chart.PlotBy != XlRowCol.xlRows)
          return "False(switch Row/Column)";
      }
      catch (Exception ex)
      {
        return "False (khong tim thay Chart 4)";
      }
      return str;
    }
    ...
    private static string Cau2(Application a, Workbook d)
    {
      ...
      try
      {
        if (worksheet.Shapes.Item((object) "Chart 3").Chart.Legend == null)
    ...
    private static string Cau3(Application a, Workbook d)
    {
      ...
      try
      {
        worksheet.Shapes.Item((object) "Chart 1");
    ...
    private static string Cau4(Application a, Workbook d)
    {
      ...
      try
      {
        worksheet = (Worksheet) d.Worksheets[(object) "Inbound call"];
      }
      catch (Exception ex)
      {
