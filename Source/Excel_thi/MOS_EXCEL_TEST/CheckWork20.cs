...
// Type: MOS_EXCEL_TEST.CheckWork20
...
namespace MOS_EXCEL_TEST
{
  public static class CheckWork20
  {
    ...
    private static string Cau0(Application a, Workbook d)
    {
      try
      {
        Worksheet worksheet1 = (Worksheet) d.Worksheets[(object) "Weekly Summary"];
        if (worksheet1.get_Range((object) "j4", (object) "j4").Formula.ToString() != "=AVERAGE('Weekly Summary'!$C4:$I4)")
          return "False(Auto fill)";
        if (worksheet1.get_Range((object) "j4", (object) "j4").Interior.TintAndShade.ToString() == "0.799981688894314")
          return "False(chon option without format)";
        Worksheet worksheet2 = (Worksheet) d.Worksheets[(object) "Weekly Summary"];
        if (worksheet2.get_Range((object) "J9", (object) "J9").Formula.ToString() != "=AVERAGE('Weekly Summary'!$C9:$I9)")
          return "False(Auto fill)";
        if (worksheet2.get_Range((object) "J9", (object) "J9").Interior.TintAndShade.ToString() == "0")
          return "False(chon option without format)";
        Worksheet worksheet3 = (Worksheet) d.Worksheets[(object) "Weekly Summary"];
        if (worksheet3.get_Range((object) "J10", (object) "J10").Formula.ToString() != "=AVERAGE('Weekly Summary'!$C10:$I10)")
          return "False(Auto fill)";
        if (worksheet3.get_Range((object) "J10", (object) "J10").Interior.TintAndShade.ToString() == "0.799981688894314")
          return "False(chon option without format)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau1(Application a, Workbook d)
    {
      try
      {
        Worksheet worksheet = (Worksheet) d.Worksheets[(object) "Monthly Summary"];
        if (worksheet.ListObjects.Count != 1)
          return "False(chuyen day o thanh bang)";
        if (worksheet.ListObjects[(object) 1].ListRows.Count != 8)
          return "False(table co tieu de)";
      }
      catch (Exception ex)
      {
        return "False (Something not finish!)";
    ...
    private static string Cau2(Application a, Workbook d)
    {
      try
      {
        if (((_Worksheet) d.Worksheets[(object) "Weekly Summary"]).Shapes.Count != 1)
          return "False(chen pareto chart)";
      }
      catch (Exception ex)
      {
        return "False (Rename)";
    ...
    private static string Cau3(Application a, Workbook d)
    {
      ...
      try
      {
        worksheet = (Worksheet) d.Worksheets[(object) "Survey Results"];
      }
      catch (Exception ex)
      {
        return "Fales (Survey Results worksheet not found)";
      }
      try
      {
        if (!worksheet.get_Range((object) "F6", (object) "F6").Formula.ToString().Contains("=LEFT(E6"))
          return "False (ham left)";
      }
      catch (Exception ex)
      {
        return "False (chen cong thuc o F6)";
      }
      return str;
    }
