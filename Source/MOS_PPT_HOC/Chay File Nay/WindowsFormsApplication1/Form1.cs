...
public class Form1 : Form
{
  ...
  private void LuuDiem()
  {
    ...
    __Boxed<int> month = (ValueType) now.Month;
    objArray2[2] = (object) month;
    objArray1[3] = (object) "|";
    object[] objArray3 = objArray1;
    now = DateTime.Now;
    // ISSUE: variable of a boxed type
    __Boxed<int> year = (ValueType) now.Year;
  ...
  public Form1()
  {
    ...
    new ComAwareEventInfo(typeof (EApplication_Event), "PresentationBeforeClose").AddEventHandler((object) this.a, (Delegate) new EApplication_PresentationBeforeCloseEventHandler((object) this, (UIntPtr) __methodptr(a_PresentationBeforeClose)));
    // ISSUE: method pointer
    // ISSUE: object of a compiler-generated type is created
    new ComAwareEventInfo(typeof (EApplication_Event), "ProtectedViewWindowBeforeClose").AddEventHandler((object) this.a, (Delegate) new EApplication_ProtectedViewWindowBeforeCloseEventHandler((object) this, (UIntPtr) __methodptr(a_ProtectedViewWindowBeforeClose)));
  }
