...
// Type: WindowsFormsApplication1.S12
...
internal class S12
{
  public static string CheckCau(int causo, Application a, Presentation d)
  {
    switch (causo)
    {
      ...
      case 10:
        return S12.Cau10(a, d);
      case 11:
        return S12.cau11(a, d);
      case 12:
        return S12.cau12(a, d);
      case 13:
        return S12.cau13(a, d);
      default:
  ...
  private static string Cau6(Application a, Presentation d)
  {
    try
    {
      if (a.ActivePresentation.HandoutMaster.HeadersFooters.Footer.Text != "Draft")
        return "False(Draft)";
    }
    catch (Exception ex)
    {
