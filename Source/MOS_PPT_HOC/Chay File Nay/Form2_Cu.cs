...
namespace MOS_PPT_LEARN
{
    ...
    public class Form2_Cu : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label4.Location = new Point(183, 77);
            this.label4.Name = "label4";
            this.label4.Size = new Size(332, 31 /*0x1F*/);
            this.label4.TabIndex = 8;
            this.label4.Text = "PM POWERPOINT 2019";
            ...
            this.textBoxPassSo.Size = new Size(185, 31 /*0x1F*/);
            ...
            this.BackColor = Color.FromArgb(64 /*0x40*/, 64 /*0x40*/, 64 /*0x40*/);
        ...
        private void WritrMac(string mac, DateTime ngay, string path)
        {
            ...
            textWriter.WriteLine($"{(object)ngay.Year}|{(object)ngay.Month}|{(object)ngay.Day}");
        ...
        public static DateTime GetMicrosoftNistTime()
        {
            return DateTime.ParseExact(WebRequest.Create("https://www.google.com/search?q=Iraq time").GetResponse().Headers["date"], "ddd, dd MMM yyyy HH:mm:ss 'GMT'", (IFormatProvider)CultureInfo.InvariantCulture.DateTimeFormat, DateTimeStyles.AssumeUniversal);
        }
      ...
      "nist.netservicesgroup.com"
        ...
        public string getMac()
        {
            ...
            foreach (NetworkInterface networkInterface in NetworkInterface.GetAllNetworkInterfaces())
            {
                if (networkInterface.GetPhysicalAddress().ToString() != "")
                    mac = $"{mac}{networkInterface.GetPhysicalAddress().ToString()}|";
            }
            return mac;
        }
        ...
        private void check()
        {
            try
            {
                this.dt = Form2_Cu.GetDateFromeInternet();
                ...
                else if (System.IO.File.Exists(Path.Combine(Application.StartupPath, "zip\\b")))
                {
                    try
                    {
                        ...
                        if (this.GetMacAddress(mac))
                        {
                            ...
                            {
                                int num = (int)MessageBox.Show("Phần mềm hết hạng, vào gg meet hoặc thimos1000.vn để được hỗ trợ tiếp");
