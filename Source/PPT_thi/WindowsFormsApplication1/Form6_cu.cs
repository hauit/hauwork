...
// Type: WindowsFormsApplication1.Form6
...
namespace WindowsFormsApplication1
{
  public class Form6_cu : Form
  {
    ...
    public Form6_cu() => this.InitializeComponent();
    ...
    private void Form3_Load(object sender, EventArgs e)
    {
      ...
      if (!File.Exists("d:\\config\\cs4.rtf"))
        return;
      this.richTextBox1.LoadFile("d:\\config\\cs4.rtf");
    }
