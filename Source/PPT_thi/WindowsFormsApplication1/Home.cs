...
namespace MOS_PPT_TEST
{
    ...
    public static class ClsListQuestion
    {
        private static List<ClsQuestion> listQuestion = new List<ClsQuestion>
        {
            ...
            new ClsQuestion(true,9,53,"https://go.mos360.vn/mosppt009","Sau slide \"Extra Activities\", tạo các slide bằng cách nhập tập tin Destinations từ bên ngoài trong thư mục Documents","After the \"Extra Activities\" slide, create slides by importing the outline from the Destinations document in the Documents folder."),
            ...
            new ClsQuestion(true,19,69,"https://go.mos360.vn/mosppt019","Trên slide \"Become a Frequent Flyer, đối với văn bản \"Registration is easy and fast\" hãy thay đổi màu văn bản thành màu Blue-Gray, Accent 1","On the \"Become a Frequent Flyer\" slide, for the text \"Registration is easy and fast\", change the text fill color to Blue-Gray, Accent 1"),
            ...
            new ClsQuestion(true,31,35,"https://go.mos360.vn/mosppt031","Trên slide 5, sử dụng tính năng mô hình 3D, chèn mô hình Piano từ thư mục 3D Object. Điều chỉnh chiều cao mô hình thành 2\" (5.08cm) và chiều rộng 1.78\" (4.15cm). Đặt mô hình vào trong hình chữ nhật ở bên trái. Vị trí chính xác của mô hình thì không bắt buộc.","On slide 5, use the 3D Models feature to insert the Piano model from the 3D Objects folder. Resize the model to a height of 2\" (5.08 cm) and a width of 1.78\" (4.15 cm). Place the model in the empty rectangle on the left. The exact position of the model does not matter."),
            ...
            new ClsQuestion(true,44,75,"https://go.mos360.vn/mosppt044","Trên slide \"Get Involved\", chèn video Sailing từ thư mục video. đặt video ở góc dưới bên phải của slide. Kích thước và vị trí của video thì không cần chính xác.","On the \"Get Involved\" slide, insert the Sailing video from the Videos folder. Place the video in the lower-right corner of the slide. The exact size and position of the video do not matter."),
