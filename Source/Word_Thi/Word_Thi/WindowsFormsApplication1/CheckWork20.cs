    ...
    private static string Cau12(Application a, Document d)
    {
      foreach (Table table in d.Tables)
      {
        if (table.Columns.Count == 5)
        {
          ...
          if (CheckWork20.\u003CCau12\u003Eo__SiteContainer1.\u003C\u003Ep__Site2 == null)
          {
            // ISSUE: reference to a compiler-generated field
            CheckWork20.\u003CCau12\u003Eo__SiteContainer1.\u003C\u003Ep__Site2 = CallSite<Func<CallSite, object, Style>>.Create(Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork20)));
          }
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          // ISSUE: variable of a compiler-generated type
          Style style = CheckWork20.\u003CCau12\u003Eo__SiteContainer1.\u003C\u003Ep__Site2.Target((CallSite) CheckWork20.\u003CCau12\u003Eo__SiteContainer1.\u003C\u003Ep__Site2, table.Style);
          if (style.NameLocal != "List Table 4 - Accent 1")
            return "False(" + style.NameLocal + ")";
          // ISSUE: reference to a compiler-generated method
          // ISSUE: reference to a compiler-generated method
