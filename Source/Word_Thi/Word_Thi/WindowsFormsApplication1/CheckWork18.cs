...
// Type: WindowsFormsApplication1.CheckWork18
  ...
  public static class CheckWork18
  {
    public static string Check(int cauLon, Application a, Document d)
    {
      switch (cauLon)
      {
        ...
        case 8:
          return CheckWork18.Cau8(a, d);
        case 9:
          return CheckWork18.Cau9(a, d);
        case 10:
          return CheckWork18.Cau10(a, d);
        case 11:
          return CheckWork18.Cau11(a, d);
        case 12:
          return CheckWork18.Cau12(a, d);
        case 13:
          return CheckWork18.Cau13(a, d);
        case 14:
          return CheckWork18.Cau14(a, d);
        case 15:
          return CheckWork18.Cau15(a, d);
        case 16:
          return CheckWork18.Cau16(a, d);
        case 17:
          return CheckWork18.Cau17(a, d);
        case 18:
          return CheckWork18.Cau18(a, d);
        case 19:
          return CheckWork18.Cau19(a, d);
        case 20:
          return CheckWork18.Cau20(a, d);
        case 21:
          return CheckWork18.Cau21(a, d);
        case 22:
          return CheckWork18.Cau22(a, d);
        case 23:
          return CheckWork18.Cau23(a, d);
        case 24:
          return CheckWork18.Cau24(a, d);
        case 25:
          return CheckWork18.Cau25(a, d);
        case 26:
          return CheckWork18.Cau26(a, d);
        case 27:
          return CheckWork18.Cau27(a, d);
        case 28:
          return CheckWork18.Cau28(a, d);
        case 29:
          return CheckWork18.Cau29(a, d);
        default:
          return "";
      }
    }
    ...
    private static string Cau0(Application a, Document d)
    {
      ...
      {
        int Index = 1;
        while (Index < d.Paragraphs.Count && !d.Paragraphs[Index].Range.Text.Contains("SOME QUESTION?"))
          ++Index;
        if (Index >= d.Paragraphs.Count)
          return "False (ap dung Clack and White classic)";
        if (d.Paragraphs[Index].Range.Font.TextColor.RGB.ToString() != "-16777216")
          return "False(chon trong group formating cua the design)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau1(Application a, Document d)
    {
      ...
      {
        int Index = 1;
        while (Index < d.Paragraphs.Count && !d.Paragraphs[Index].Range.Text.Contains("[COMPANY NAME]"))
          ++Index;
        if (Index >= d.Paragraphs.Count)
          return "False (khong tim thay noi dung)";
        if (d.Paragraphs[Index].Range.ParagraphFormat.LineSpacing.ToString() != "14" || d.Paragraphs[Index + 1].Range.ParagraphFormat.LineSpacing.ToString() != "14")
          return "False(14 pt)";
        if (d.Paragraphs[Index + 2].Range.ParagraphFormat.LineSpacing.ToString() != "14")
          return "False(14 pt)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau2(Application a, Document d)
    {
      ...
      {
        int Index = 1;
        while (Index < d.Paragraphs.Count && !d.Paragraphs[Index].Range.Text.Contains("[PLAWER PHOTO]"))
          ++Index;
        if (Index >= d.Paragraphs.Count)
          return "False (duoi [PLAWER PHOTO])";
        if (!d.Paragraphs[Index + 1].Range.Text.Contains("we promised, you"))
          return "False(chen du lieu tu file)";
      }
      catch (Exception ex)
      {
        return "False (Something not finish!)";
    ...
    private static string Cau3(Application a, Document d)
    {
      ...
      {
        int Index = 1;
        while (Index < d.Paragraphs.Count && !d.Paragraphs[Index].Range.Text.Contains("What elements do you want to include in a brochure"))
          ++Index;
        if (Index >= d.Paragraphs.Count)
          return "False (khong tim thay What elements do you want to include in a brochure)";
        if (d.Paragraphs[Index - 1].Range.InlineShapes.Count != 1)
          return "False(chen hinh doan tren doan What elements do you want to include in a brochure)";
      }
      catch (Exception ex)
      {
        return "False (Something not finish!)";
    ...
    private static string Cau5(Application a, Document d)
    {
      ...
      if (CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site1 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site1 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork18)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style1 = CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site1.Target((CallSite) CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site1, d.Paragraphs[Index].Style);
      ...
      if (Index >= 50)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site2 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site2 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork18)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style2 = CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site2.Target((CallSite) CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site2, d.Paragraphs[Index].Style);
      ...
      if (Index >= 50)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site3 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site3 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork18)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style3 = CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site3.Target((CallSite) CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site3, d.Paragraphs[Index].Style);
      ...
      if (Index >= 50)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site4 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site4 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork18)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style4 = CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site4.Target((CallSite) CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site4, d.Paragraphs[Index].Style);
      ...
      if (Index >= 50)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site5 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site5 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork18)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style5 = CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site5.Target((CallSite) CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site5, d.Paragraphs[Index].Style);
      ...
      if (Index >= 150)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site6 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site6 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork18)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style6 = CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site6.Target((CallSite) CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site6, d.Paragraphs[Index].Style);
      ...
      if (Index >= 150)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site7 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site7 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork18)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style7 = CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site7.Target((CallSite) CheckWork18.\u003CCau5\u003Eo__SiteContainer0.\u003C\u003Ep__Site7, d.Paragraphs[Index].Style);
