    ...
    private static string Cau25(Application a, Document d)
    {
      ...
      foreach (Table table in d.Tables)
      {
        if (table.Columns.Count == 8)
        {
          ...
          if (CheckWork6.\u003CCau25\u003Eo__SiteContainer9.\u003C\u003Ep__Sitea == null)
          {
            // ISSUE: reference to a compiler-generated field
            CheckWork6.\u003CCau25\u003Eo__SiteContainer9.\u003C\u003Ep__Sitea = CallSite<Func<CallSite, object, TableStyle>>.Create(Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (TableStyle), typeof (CheckWork6)));
          }
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          // ISSUE: variable of a compiler-generated type
          TableStyle tableStyle = CheckWork6.\u003CCau25\u003Eo__SiteContainer9.\u003C\u003Ep__Sitea.Target((CallSite) CheckWork6.\u003CCau25\u003Eo__SiteContainer9.\u003C\u003Ep__Sitea, table.Style);
          str = "True";
        }
      }
      return str;
