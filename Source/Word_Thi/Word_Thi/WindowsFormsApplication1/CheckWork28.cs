...
// Type: MOS_WORD_TEST.CheckWork28
    ...
    public static class CheckWork28
    {
        ...
        private static string Cau0(Application a, Document d)
        {
            try
            {
                ...
                var style1 = d.Paragraphs[Index1].Range.Characters[1].get_Style() as Style;
                if (style1 == null || style1.NameLocal != "Strong")
                ...
                if (foundIndex == -1)
                    return "False (khong tim thay du lieu)";
                var style2 = d.Paragraphs[foundIndex].Range.Characters[1].get_Style() as Style;
                if (style2 == null || style2.NameLocal != "Strong")
