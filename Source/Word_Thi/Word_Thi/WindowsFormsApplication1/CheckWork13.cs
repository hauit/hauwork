...
// Type: WindowsFormsApplication1.CheckWork13
...
{
  public static class CheckWork13
  {
    public static string Check(int cauLon, Application a, Document d)
    {
      ...
      {
        case 0:
          return CheckWork13.Cau1(a, d);
        case 1:
          return CheckWork13.Cau0(a, d);
        case 2:
          return CheckWork13.Cau2(a, d);
        case 3:
          return CheckWork13.Cau3(a, d);
        case 4:
          return CheckWork13.Cau4(a, d);
        case 5:
          return CheckWork13.Cau5(a, d);
        case 6:
          return CheckWork13.Cau6(a, d);
        case 7:
          return CheckWork13.Cau7(a, d);
        case 8:
          return CheckWork13.Cau8(a, d);
        case 9:
          return CheckWork13.Cau9(a, d);
        case 10:
          return CheckWork13.Cau10(a, d);
        case 11:
          return CheckWork13.Cau11(a, d);
        case 12:
          return CheckWork13.Cau12(a, d);
        case 13:
          return CheckWork13.Cau13(a, d);
        case 14:
          return CheckWork13.Cau14(a, d);
        case 15:
          return CheckWork13.Cau15(a, d);
        case 16:
          return CheckWork13.Cau16(a, d);
        case 17:
          return CheckWork13.Cau17(a, d);
        case 18:
          return CheckWork13.Cau18(a, d);
        case 19:
          return CheckWork13.Cau19(a, d);
        case 20:
          return CheckWork13.Cau20(a, d);
        case 21:
          return CheckWork13.Cau21(a, d);
        case 22:
          return CheckWork13.Cau22(a, d);
        case 23:
          return CheckWork13.Cau23(a, d);
        case 24:
          return CheckWork13.Cau24(a, d);
        case 25:
          return CheckWork13.Cau25(a, d);
        case 26:
          return CheckWork13.Cau26(a, d);
        case 27:
          return CheckWork13.Cau27(a, d);
        case 28:
          return CheckWork13.Cau28(a, d);
        case 29:
          return CheckWork13.Cau29(a, d);
        default:
          return "";
      }
    }
    ...
    private static string Cau3(Application a, Document d)
    {
      try
      {
        ...
        for (int Index = 1; Index < d.Paragraphs.Count; ++Index)
        {
          if (d.Paragraphs[Index].Range.Text.Contains("Manufacturing process"))
          {
            num = Index;
            break;
          }
        ...
        if (num == 0)
          return "False(không sửa tiêu đề Manufacturing process)";
        if (d.Paragraphs[num + 2].Range.InlineShapes.Count == 0)
          return "Fasle(không chèn xóa thay đổi layout SmartArt)";
        if (d.Paragraphs[num + 2].Range.InlineShapes[1].AlternativeText == "")
    ...
    private static string Cau26(Application a, Document d)
    {
      ...
      object target1 = type.InvokeMember("Item", BindingFlags.GetProperty, (Binder) null, documentProperties, new object[1]
      {
        (object) "Title"
      });
      if (target1.GetType().InvokeMember("Value", BindingFlags.GetProperty, (Binder) null, target1, new object[0]).ToString() != "Boating Vacations")
        return "False";
      object target2 = type.InvokeMember("Item", BindingFlags.GetProperty, (Binder) null, documentProperties, new object[1]
      {
        (object) "Comments"
      });
      return target2.GetType().InvokeMember("Value", BindingFlags.GetProperty, (Binder) null, target2, new object[0]).ToString() != "Please review yearly" ? "False" : str;
    }
