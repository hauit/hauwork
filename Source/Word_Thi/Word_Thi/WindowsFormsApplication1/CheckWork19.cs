...
// Type: WindowsFormsApplication1.CheckWork19
...
namespace WindowsFormsApplication1
{
  public static class CheckWork19
  {
    ...
    private static string Cau0(Application a, Document d)
    {
      ...
      {
        int Index1 = 1;
        while (Index1 < d.Paragraphs.Count && !d.Paragraphs[Index1].Range.Text.Contains("Initial Plant Purchase"))
          ++Index1;
        if (Index1 >= d.Paragraphs.Count)
          return "False (khong tim thay du lieu)";
        // ISSUE: reference to a compiler-generated field
        if (CheckWork19.\u003CCau0\u003Eo__SiteContainer0.\u003C\u003Ep__Site1 == null)
        {
          // ISSUE: reference to a compiler-generated field
          CheckWork19.\u003CCau0\u003Eo__SiteContainer0.\u003C\u003Ep__Site1 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork19)));
        }
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: variable of a compiler-generated type
        Style style1 = CheckWork19.\u003CCau0\u003Eo__SiteContainer0.\u003C\u003Ep__Site1.Target((CallSite) CheckWork19.\u003CCau0\u003Eo__SiteContainer0.\u003C\u003Ep__Site1, d.Paragraphs[Index1].Style);
        if (style1.NameLocal != "High")
          return "False(High style trang 1)";
        for (int Index2 = Index1; Index2 < d.Paragraphs.Count; ++Index2)
        {
          if (d.Paragraphs[Index2].Range.Text.Contains("Suggested Purchases"))
          {
            Index1 = Index2;
            break;
          }
        ...
        if (Index1 >= d.Paragraphs.Count)
          return "False (khong tim thay du lieu)";
        // ISSUE: reference to a compiler-generated field
        if (CheckWork19.\u003CCau0\u003Eo__SiteContainer0.\u003C\u003Ep__Site2 == null)
        {
          // ISSUE: reference to a compiler-generated field
          CheckWork19.\u003CCau0\u003Eo__SiteContainer0.\u003C\u003Ep__Site2 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork19)));
        }
        // ISSUE: reference to a compiler-generated field
        // ISSUE: reference to a compiler-generated field
        // ISSUE: variable of a compiler-generated type
        Style style2 = CheckWork19.\u003CCau0\u003Eo__SiteContainer0.\u003C\u003Ep__Site2.Target((CallSite) CheckWork19.\u003CCau0\u003Eo__SiteContainer0.\u003C\u003Ep__Site2, d.Paragraphs[Index1].Style);
        if (style2.NameLocal != "High")
          return "False(High style trang 2)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau2(Application a, Document d)
    {
      ...
      {
        int Index1 = 1;
        while (Index1 < d.Paragraphs.Count && !d.Paragraphs[Index1].Range.Text.Contains("we are planning to buy."))
          ++Index1;
        if (Index1 >= d.Paragraphs.Count)
          return "False (we are planning to buy.)";
        if (!d.Paragraphs[Index1].Range.Text.Contains("It stands to reason that these numbers"))
          return "False(di chuyen no nam sau we are planning to buy.)";
    ...
    private static string Cau4(Application a, Document d)
    {
      ...
      if (Index >= 50)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site4 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site4 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork19)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style1 = CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site4.Target((CallSite) CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site4, d.Paragraphs[Index].Style);
      ...
      if (Index >= 50)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site5 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site5 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork19)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style2 = CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site5.Target((CallSite) CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site5, d.Paragraphs[Index].Style);
      ...
      if (Index >= 50)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site6 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site6 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork19)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style3 = CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site6.Target((CallSite) CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site6, d.Paragraphs[Index].Style);
      ...
      if (Index >= 50)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site7 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site7 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork19)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style4 = CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site7.Target((CallSite) CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site7, d.Paragraphs[Index].Style);
      ...
      if (Index >= 50)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site8 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site8 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork19)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style5 = CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site8.Target((CallSite) CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site8, d.Paragraphs[Index].Style);
      ...
      if (Index >= 150)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site9 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site9 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork19)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style6 = CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site9.Target((CallSite) CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Site9, d.Paragraphs[Index].Style);
      ...
      if (Index >= 150)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Sitea == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Sitea = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork19)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style7 = CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Sitea.Target((CallSite) CheckWork19.\u003CCau4\u003Eo__SiteContainer3.\u003C\u003Ep__Sitea, d.Paragraphs[Index].Style);
