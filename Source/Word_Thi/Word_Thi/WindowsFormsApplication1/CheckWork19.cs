    ...
    public static class CheckWork19
    {
        ...
        private static string Cau0(Application a, Document d)
        {
            try
            {
                ...
                var style1 = d.Paragraphs[Index1].get_Style() as Style;
                if (style1 == null || style1.NameLocal != "High")
                    return "False(High style trang 1)";
                int Index2 = Index1;
                for (; Index2 < d.Paragraphs.Count; ++Index2)
                {
                ...
                if (Index1 >= d.Paragraphs.Count)
                    return "False (khong tim thay du lieu)";
                var style2 = d.Paragraphs[Index1].get_Style() as Style;
                if (style2 == null || style2.NameLocal != "High")
