...
// Type: WindowsFormsApplication1.CheckWork16
  ...
  public static class CheckWork16
  {
    public static string Check(int cauLon, Application a, Document d)
    {
      switch (cauLon)
      {
        ...
        case 10:
          return CheckWork16.Cau10(a, d);
        case 11:
          return CheckWork16.Cau11(a, d);
        case 12:
          return CheckWork16.Cau12(a, d);
        case 13:
          return CheckWork16.Cau13(a, d);
        case 14:
          return CheckWork16.Cau14(a, d);
        case 15:
          return CheckWork16.Cau15(a, d);
        case 16:
          return CheckWork16.Cau16(a, d);
        case 17:
          return CheckWork16.Cau17(a, d);
        case 18:
          return CheckWork16.Cau18(a, d);
        case 19:
          return CheckWork16.Cau19(a, d);
        case 20:
          return CheckWork16.Cau20(a, d);
        case 21:
          return CheckWork16.Cau21(a, d);
        case 22:
          return CheckWork16.Cau22(a, d);
        case 23:
          return CheckWork16.Cau23(a, d);
        case 24:
          return CheckWork16.Cau24(a, d);
        case 25:
          return CheckWork16.Cau25(a, d);
        case 26:
          return CheckWork16.Cau26(a, d);
        case 27:
          return CheckWork16.Cau27(a, d);
        case 28:
          return CheckWork16.Cau28(a, d);
        case 29:
          return CheckWork16.Cau29(a, d);
        default:
          return "";
      }
    }
    ...
    private static string Cau0(Application a, Document d)
    {
      try
      {
        if (d.Sections.Count != 3)
          return "False(chia 2 cot chi van ban de yeu cau)";
        if (d.Sections[2].PageSetup.TextColumns.Count != 2)
          return "False(chia 2 cot section 2)";
        if (d.Sections[2].Range.Text.Substring(0, 4) != "Coll")
          return "False(bat dau tai College of Arts & Sciences)";
        if (d.Sections[3].Range.Text.Substring(0, 4) != "Fina")
          return "False(boi den den truc Final step)";
        if (d.Sections[2].PageSetup.TextColumns.Spacing.ToString() != "17.3")
          return "False(khoang cach giua 2 cot)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau1(Application a, Document d)
    {
      ...
      {
        int Index = 1;
        while (Index < d.Paragraphs.Count + 1 && !d.Paragraphs[Index].Range.Text.Contains("Step 3"))
          ++Index;
        if (Index >= d.Paragraphs.Count + 1)
          return "False(kho tim thay Step 3)";
        if (d.Paragraphs[Index].Range.Text != "\vStep 3: Evaluate Your Investment.\r")
          return "False(chen ngat dong benh trai Step 3)";
      }
      catch (Exception ex)
      {
        return "False (Something not finish!)";
    ...
    private static string Cau2(Application a, Document d)
    {
      ...
      {
        int Index = 1;
        while (Index < d.Paragraphs.Count && !d.Paragraphs[Index].Range.Text.Contains("Sources of funding"))
          ++Index;
        if (Index >= d.Paragraphs.Count)
          return "False (khong tim thay Sources of funding)";
        if (d.Paragraphs[Index + 1].Range.ListFormat.ListType != WdListType.wdListPictureBullet)
          return "False(picture)";
        if (d.Paragraphs[Index + 4].Range.ListFormat.ListType != WdListType.wdListPictureBullet)
          return "False(picture)";
      }
      catch (Exception ex)
      {
    ...
    private static string Cau3(Application a, Document d)
    {
      try
      {
        ...
        if (d.Shapes[ref Index1].Fill.PictureEffects.Count != 1)
          return "False(add hieu ung nghe thuat)";
        object Index2 = (object) "Picture 2";
        if (d.Shapes[ref Index2].Fill.PictureEffects[1].Type.ToString() != "msoEffectPhotocopy")
    ...
    private static string Cau4(Application a, Document d)
    {
      try
      {
        object Index = (object) "Picture 2";
        if (d.Shapes[ref Index].Line.ForeColor.RGB.ToString() != "11957550")
    ...
    private static string Cau5(Application a, Document d)
    {
      ...
      if (CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site4 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site4 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork16)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style1 = CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site4.Target((CallSite) CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site4, d.Paragraphs[Index].Style);
      ...
      if (Index >= 50)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site5 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site5 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork16)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style2 = CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site5.Target((CallSite) CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site5, d.Paragraphs[Index].Style);
      ...
      if (Index >= 50)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site6 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site6 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork16)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style3 = CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site6.Target((CallSite) CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site6, d.Paragraphs[Index].Style);
      ...
      if (Index >= 50)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site7 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site7 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork16)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style4 = CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site7.Target((CallSite) CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site7, d.Paragraphs[Index].Style);
      ...
      if (Index >= 50)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site8 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site8 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork16)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style5 = CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site8.Target((CallSite) CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site8, d.Paragraphs[Index].Style);
      ...
      if (Index >= 150)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site9 == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site9 = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork16)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style6 = CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site9.Target((CallSite) CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Site9, d.Paragraphs[Index].Style);
      ...
      if (Index >= 150)
        return "False";
      // ISSUE: reference to a compiler-generated field
      if (CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Sitea == null)
      {
        // ISSUE: reference to a compiler-generated field
        CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Sitea = CallSite<Func<CallSite, object, Style>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (Style), typeof (CheckWork16)));
      }
      // ISSUE: reference to a compiler-generated field
      // ISSUE: reference to a compiler-generated field
      // ISSUE: variable of a compiler-generated type
      Style style7 = CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Sitea.Target((CallSite) CheckWork16.\u003CCau5\u003Eo__SiteContainer3.\u003C\u003Ep__Sitea, d.Paragraphs[Index].Style);
