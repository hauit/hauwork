    ...
    private static string Cau25(Application a, Document d)
    {
      ...
      foreach (Microsoft.Office.Interop.Word.Table table in d.Tables)
      {
        if (table.Columns.Count == 8)
        {
          ...
          if (CheckWork4.\u003CCau25\u003Eo__SiteContainer9.\u003C\u003Ep__Sitea == null)
          {
            // ISSUE: reference to a compiler-generated field
            CheckWork4.\u003CCau25\u003Eo__SiteContainer9.\u003C\u003Ep__Sitea = CallSite<Func<CallSite, object, TableStyle>>.Create(Microsoft.CSharp.RuntimeBinder.Binder.Convert(CSharpBinderFlags.ConvertExplicit, typeof (TableStyle), typeof (CheckWork4)));
          }
          // ISSUE: reference to a compiler-generated field
          // ISSUE: reference to a compiler-generated field
          // ISSUE: variable of a compiler-generated type
          TableStyle tableStyle = CheckWork4.\u003CCau25\u003Eo__SiteContainer9.\u003C\u003Ep__Sitea.Target((CallSite) CheckWork4.\u003CCau25\u003Eo__SiteContainer9.\u003C\u003Ep__Sitea, table.Style);
          str = "True";
        }
      }
      return str;
