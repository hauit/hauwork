...
namespace WindowsFormsApplication1.Base
{
    ...
    public static class ClsListQuestion
    {
        private static List<ClsQuestion> listQuestion = new List<ClsQuestion>
        {
            ...
            new ClsQuestion(true,23,38,"https://go.mos360.vn/mosexcel023","Lợi nhuận bằng giá bán trừ giá mua. Trên trang tính \"Non-Fiction\", thêm công thức để tính lợi nhuận mỗi quyển sách tại cột \"Margin\". Giữ nguyên định dạng ban đầu của cột \"Margin\".","Profit equals the selling price minus the purchase price. On the \"Non-Fiction\" worksheet, add a formula to calculate the profit per book in the \"Margin\" column. Keep the original format of the \"Margin\" column."),
