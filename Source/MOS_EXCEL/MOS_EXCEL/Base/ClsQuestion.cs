...
namespace WindowsFormsApplication1.Base
{
    ...
    public static class ClsListQuestion
    {
        private static List<ClsQuestion> listQuestion = new List<ClsQuestion>
        {
            ...
            new ClsQuestion(true,79,23,"youtube.com","Trên trang tính \"Quote\" , dời các ô E6:F30 xuống cho khớp với bảng dữ liệu bằng cách chèn các ô E6:F6","On the \"Quote\" worksheet, move cells E6:F30 down to match the data table by inserting cells E6:F6"),
            ...
            new ClsQuestion(true,19,71,"youtube.com","Trên trang tính \"Revneue\", chuyển đổi các ô A3:B7 thành dạng bảng với tiêu đề. Dùng kiểu \"Green, Table Style Light 14\"","On the \"Revneue\" worksheet, convert cells A3:B7 to a table with headings. Use the \"Green, Table Style Light 14\" style"),
